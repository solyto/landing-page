...
<section class="w-full bg-gray-50 py-20 md:py-32">
	<div class="mx-auto max-w-5xl px-6">

		<!-- Header row -->
		<div class="reveal mb-16 md:mb-24" use:reveal>
			<div class="flex flex-wrap items-start justify-between gap-6">
				<h2 class="text-4xl md:text-6xl font-bold text-gray-900 leading-tight max-w-xl">
		...
		<div class="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-20">
			...
			<div class="reveal flex flex-col gap-6" use:reveal>
				...
				<div class="flex flex-wrap gap-4 pt-2">
					<a
						...
						class="inline-flex items-center gap-2 rounded-full border border-gray-300 px-5 py-2.5 text-sm font-semibold text-gray-700 transition-colors hover:border-s-teal hover:text-s-teal"
					>
			...
			<div class="reveal flex flex-col gap-6" use:reveal={{ delay: 100 }}>
				...
				<!-- Terminal block -->
				<div class="rounded-xl bg-gray-900 border border-gray-200 overflow-hidden">
					<div class="flex items-center gap-1.5 px-4 py-3 border-b border-gray-700">
						<span class="size-2.5 rounded-full bg-gray-600"></span>
						<span class="size-2.5 rounded-full bg-gray-600"></span>
						<span class="size-2.5 rounded-full bg-gray-600"></span>
					</div>
					<div class="px-5 py-4">
				...
				<a
					...
					target="_blank"
					rel="noopener noreferrer"
					class="inline-flex items-center gap-2 self-start rounded-full border border-gray-300 px-5 py-2.5 text-sm font-semibold text-gray-700 transition-colors hover:border-s-teal hover:text-s-teal"
				>
